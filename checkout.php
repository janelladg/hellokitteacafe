...
<form action="" method="post">
   ...
   <input type="text" name="total_products" value="<?= $total_products; ?>">
   <input type="text" name="total_price" value="<?= $grand_total; ?>" value="">
   <input type="text" name="name" value="<?= $fetch_profile['name'] ?>">
   <input type="text" name="number" value="<?= $fetch_profile['number'] ?>">
   <input type="text" name="email" value="<?= $fetch_profile['email'] ?>">
   <input type="text" name="address" value="<?= $fetch_profile['address'] ?>">
   ...
   <div class="user-info">
      ...
      <input type="submit" value="place order" class="btn" style="width:100%; background:var(--red); color:var(--white);" name="submit" <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>>
   </div>
